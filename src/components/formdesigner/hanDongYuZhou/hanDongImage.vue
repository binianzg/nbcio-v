<template>
  <div class="img">
    ...
    <j-image-upload :disabled="disabled" v-model="fcz.commonDataInfo" @change="commonComponent" ></j-image-upload>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    console.log("hanDongImage mounted fcz.commonDataInfo",this.fcz.commonDataInfo)
  },
  methods: {
    commonComponent(fczInfo) {
      console.log("hanDongImage commonComponent fczInfo=",fczInfo)
