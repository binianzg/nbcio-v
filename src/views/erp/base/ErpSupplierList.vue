<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('erp_supplier')">导出</a-button>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'deliveryAddress',text:'发货地址',dictCode:''})
        fieldList.push({type:'int',value:'deliveryCycle',text:'发货周期（天）',dictCode:''})
