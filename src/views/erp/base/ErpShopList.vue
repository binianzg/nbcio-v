<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="所属部门ID">
                <j-select-depart placeholder="请选择所属部门ID" v-model="queryParam.deptId"/>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('erp_shop')">导出</a-button>
    ...
    <erp-shop-modal ref="modalForm" @ok="modalFormOk"></erp-shop-modal>
  </a-card>
</template>
...
<script>
  ...
  import ErpShopModal from './modules/ErpShopModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/base/erpShop/list",
          delete: "/base/erpShop/delete",
          deleteBatch: "/base/erpShop/deleteBatch",
          exportXlsUrl: "/base/erpShop/exportXls",
          importExcelUrl: "base/erpShop/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'sel_depart',value:'deptId',text:'所属部门ID'})
        fieldList.push({type:'BigDecimal',value:'lng',text:'经度',dictCode:''})
