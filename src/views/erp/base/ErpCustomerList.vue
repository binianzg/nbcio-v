<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('erp_customer')">导出</a-button>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'cityId',text:'地区ID',dictCode:''})
        fieldList.push({type:'string',value:'address',text:'地址',dictCode:''})
        fieldList.push({type:'string',value:'inPerson',text:'入库人',dictCode:''})
        fieldList.push({type:'string',value:'inTelephone',text:'入库手机号',dictCode:''})
        fieldList.push({type:'string',value:'inAddress',text:'入库地址',dictCode:''})
        fieldList.push({type:'int',value:'settleType',text:'结算方式',dictCode:'erp_settle'})
        fieldList.push({type:'string',value:'creditCode',text:'统一社会信用代码',dictCode:''})
        fieldList.push({type:'string',value:'taxIdentifyNo',text:'纳税人识别号',dictCode:''})
        fieldList.push({type:'string',value:'bankName',text:'开户银行',dictCode:''})
        fieldList.push({type:'string',value:'accountName',text:'户名',dictCode:''})
        fieldList.push({type:'string',value:'accountNo',text:'银行账号',dictCode:''})
