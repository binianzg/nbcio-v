<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('erp_goods_category')">导出</a-button>
    ...
    <erpGoodsCategory-modal ref="modalForm" @ok="modalFormOk"></erpGoodsCategory-modal>
  </a-card>
</template>
...
<script>
  ...
  import ErpGoodsCategoryModal from './modules/ErpGoodsCategoryModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'
  import { filterObj } from '@/utils/util';

  export default {
    name: "ErpGoodsCategoryList",
    mixins:[JeecgListMixin],
    components: {
      ErpGoodsCategoryModal
    },
    data () {
      return {
        description: 'erp_goods_category管理页面',
        // 表头
        columns: [
          {
            title:'名称',
        ...
        url: {
          list: "/goods/erpGoodsCategory/rootList",
          childList: "/goods/erpGoodsCategory/childList",
          getChildListBatch: "/goods/erpGoodsCategory/getChildListBatch",
          delete: "/goods/erpGoodsCategory/delete",
          deleteBatch: "/goods/erpGoodsCategory/deleteBatch",
          exportXlsUrl: "/goods/erpGoodsCategory/exportXls",
          importExcelUrl: "goods/erpGoodsCategory/importExcel",
        },
        expandedRowKeys:[],
