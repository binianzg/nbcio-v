    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="占用存储大小" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="storagesize">
              <a-input-number v-model="model.storagesize" placeholder="请输入占用存储大小" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="总存储大小" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="totalstoragesize">
              <a-input-number v-model="model.totalstoragesize" placeholder="请输入总存储大小" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/nd/ndStorage/add",
          edit: "/nd/ndStorage/edit",
          queryById: "/nd/ndStorage/queryById"
        }
      }
    },
    computed: {
