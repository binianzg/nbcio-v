        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="json值" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="jsonValue">
              <a-textarea :rows="16" v-model="model.jsonValue" placeholder="请输入json值" ></a-textarea>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
    ...
    data () {
      return {
        ...
        validatorRules: {
          ...
          jsonValue: [
             { required: true, message: '请输入json值!'},
          ],
          status: [
        ...
        url: {
          add: "/bs/bsSourceType/add",
          edit: "/bs/bsSourceType/edit",
          queryById: "/bs/bsSourceType/queryById"
        }
      }
    },
    computed: {
