<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('OA日历表')">导出</a-button>
    ...
    <oa-calendar-modal ref="modalForm" @ok="modalFormOk"></oa-calendar-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "/oa/oaCalendar/exportXls",
          importExcelUrl: "oa/oaCalendar/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'int',value:'type',text:'日历类型',dictCode:'oa_calendar_type'})
