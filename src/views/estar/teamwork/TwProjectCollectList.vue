      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record, index">
          ...
          <a-tooltip  title="项目设置">
            <a-icon type="setting" @click="handleEdit(record)"></a-icon>
          </a-tooltip>
...
<script>
  ...
  export default {
    ...
    created() {
      console.log("twProject created");
      this.collectpage = this.$route.query.collect;
      if(this.collectpage == true)  {
        this.url.list = "/tw/twProject/collectlist";
      }
