...
export const NbcioTableModelMixin = {
  ...
  methods: {
    ...
    /** 关闭弹窗，并将所有JNbcioEditableTable实例回归到初始状态 */
    close() {
      this.visible = false
      this.$emit('close')
    },
